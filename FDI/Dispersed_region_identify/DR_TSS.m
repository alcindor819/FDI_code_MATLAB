...
load (strcat(bipath,'hg19_TSS.mat'));   %%The TSS information
...
count(:,2)=count(:,2)\total_count;  %%For each base, calculate the fraction of TSS that has overlap with the hotspots
