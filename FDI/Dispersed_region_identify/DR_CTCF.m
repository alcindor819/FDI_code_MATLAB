...
load (strcat(bipath,'hg19_CTCF.mat'));   %%The TSS information
load (strcat(bipath,'chromosome_info.mat'));  %%The chromosome information
...
count=count_s;
count(:,2)=count(:,2)\total_count; %%For each base, calculate the fraction of CTCF that has overlap with the hotspots
